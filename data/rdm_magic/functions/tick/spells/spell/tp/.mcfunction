...
execute if score #temp maker.temp matches 1 run function rdm_magic:tick/spells/spell/tp/spread
execute if score #temp maker.temp matches 0 run function rdm_magic:tick/spells/spell/tp/projectiles
