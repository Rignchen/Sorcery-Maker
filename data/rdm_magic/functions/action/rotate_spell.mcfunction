...
data modify storage maker:temp temp.maker.Spells prepend from storage maker:temp temp.maker.Spells[-1]
data remove storage maker:temp temp.maker.Spells[-1]
