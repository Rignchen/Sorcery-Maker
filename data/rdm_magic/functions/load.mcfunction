...
item replace entity @a[tag=maker.test] hotbar.0 with warped_fungus_on_a_stick{"maker": {"Spells": [{"mana": 4,"cooldown": 1,"type": 6,"element": 1,"spell": 1,"plus":{"range": 40,"value": 1,"horse": {"speed": 0.4d,"jump": 0.9d}}}]}}
item replace entity @a[tag=maker.test] hotbar.1 with warped_fungus_on_a_stick{"maker": {"Spells": [{"mana": 4,"cooldown": 1,"type": 2,"element": 4,"spell": 3,"plus":{"range": 40,"value": 1,"horse": {"speed": 0.4d,"jump": 0.9d}}}]}}
