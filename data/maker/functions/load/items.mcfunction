...
#blocks
data modify storage maker:items all.scribbing_table set value {id:"minecraft:barrel",Count:1b,tag:{ctc:{from:"rignchen:sorcery_maker",id:"scribbing_table",traits:{"magic":1b,"block":1b,"crafting_table":1b}},maker:1b,CustomModelData:9440100,display:{Name:'{"text":"Scribbing Table","italic":false,"color":"blue"}',Lore:['{"text":"Sorcery Maker","color":"gray","italic":false}']}}}
