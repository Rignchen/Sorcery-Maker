...
data modify storage maker:items all.hat.helmet set value {id:"minecraft:iron_helmet",Count:1b,tag:{ctc:{from:"rignchen:sorcery_maker",id:"hat",     traits:{"armor/helmet":1b}},maker:{hat:{helmet:1b}},CustomModelData:9440100,display:{Name:'{"text":"Magic Hat","color":"white","italic":false}',Lore:['{"text":"Sorcery Maker","color":"gray","italic":false}']}}}
