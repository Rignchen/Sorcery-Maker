...
function smithed.damage:v0.1.0/entity/armor/toughness

#!dbg score "#damage", "smithed.damage"

# then protection
function smithed.damage:v0.1.0/entity/armor/protection

#!dbg score "#damage", "smithed.damage"

function smithed.damage:v0.1.0/entity/armor/blast_protection

#!dbg score "#damage", "smithed.damage"

# finally resistance
function smithed.damage:v0.1.0/entity/armor/resistance
...
# apply new damage
execute if score @s smithed.damage matches 1.. run function smithed.damage:v0.1.0/entity/apply
